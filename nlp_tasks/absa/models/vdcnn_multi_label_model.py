...
from nlp_tasks.absa.models import *
...
def VDCNN(sequence_length, input_dim, embedding_dim, embedding_matrix, num_class, depth=9,
    ...
    embedded_chars = Embedding(input_dim=input_dim, output_dim=embedding_dim,
    ...
    for i in range(num_class):
        # out = keras_layers.AttLayer(20, i)(out)
        x_i = Dense(20, activation="relu", kernel_regularizer=regularizers.l2(0.01))(out)
