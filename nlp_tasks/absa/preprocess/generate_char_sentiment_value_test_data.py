...
if __name__ == '__main__':
    test_public_data = file_utils.read_all_lines(data_path.test_public_char_file_path)
    test_public_subject_result = file_utils.read_all_lines(data_path
                                                           .test_public_subject_result_file_path)
    merge_data = []
    ...
    file_utils.write_lines(merge_data, data_path.test_public_for_sentiment_value_char_file_path)